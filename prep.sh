...
curl "https://raw.githubusercontent.com/ka83753/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:ka83753/workshop-control-repo
